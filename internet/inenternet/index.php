...
switch ($action) {
        ...
        if (isset($_POST['add'])) {
            ...
            if(!empty($_POST["student_id"])) {
                ...
                foreach($_POST["student_id"] as $k => $student_id) {
                    ...
                    $attendance->addAttendance($attendance_date, $student_id, $present, $absent,$late);
                }
            }
    ...
    case "student-add":
        ...
        if (isset($_POST['add'])) {
            ...
            $insertId = $student->addStudent($name, $roll_number, $dob, $class,$age);
    ...
    case "student-edit":
        ...
        if (isset($_POST['add'])) {
            ...
            $student->editStudent($name, $roll_number, $dob, $class,$age,$student_id);
            // إعادة توجيه المستخدم إلى صفحة الطلاب.
            header("Location: index.php");
        }
