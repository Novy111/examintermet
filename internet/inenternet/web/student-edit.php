...
<form name="frmAdd" method="post" action="" id="frmAdd" onSubmit="return validate();">
    ...
    <div>
        ...
        <input type="number" name="age" id="age" class="demoInputBox" value="<?php echo $result[0]["age"]; ?>">
    </div>
...
function validate() {
    ...
    if(!$("#age").val()) {
        $("#age-info").html("(required)"); // رسالة خطأ للصف
        $("#age").css('background-color','#FFFFDF'); // تغيير لون الخلفية
        valid = false;
    }
