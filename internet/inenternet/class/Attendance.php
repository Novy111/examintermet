...
class Attendance {
    ...
    // وظيفة لإضافة الحضور
    function addAttendance($attendance_date, $student_id, $present, $absent,$late) {
        // استعلام لإضافة صف جديد في جدول الحضور
        $query = "INSERT INTO tbl_attendance (attendance_date,student_id,present,absent,late) VALUES (?, ?, ?, ?,?)";
...
<?php: بداية كود PHP.
require_once ("class/DBController.php");: استيراد ملف DBController.php والذي يحتوي على كود الاتصال بقاعدة البيانات، يضمن استخدام الملف مرة واحدة فقط.
